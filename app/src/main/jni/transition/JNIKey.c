...
JNIEXPORT jbyteArray JNICALL Java_com_onem_jniwrappers_BRKey_compactSign(
        JNIEnv *env,
        jobject thiz,
        jbyteArray data) {
...
JNIEXPORT jboolean JNICALL Java_com_onem_jniwrappers_BRKey_setPrivKey(
        JNIEnv *env,
        jobject thiz,
        jbyteArray privKey) {
...
JNIEXPORT void JNICALL Java_com_onem_jniwrappers_BRKey_setSecret(
        JNIEnv *env,
        jobject thiz,
        jbyteArray privKey) {
//    __android_log_print(ANDROID_LOG_ERROR, "Message from C: ", "key is not set yet, _key: %s", _key.secret);
