...
import com.onem.onemwallet.presenter.interfaces.BRAuthCompletion;
...
import static com.onem.onemwallet.tools.util.BRConstants.SCANNER_BCH_REQUEST;
...
public class WithdrawBchActivity extends BRActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String balance = BRCurrency.getFormattedCurrencyString(this, BRSharedPrefs.getPreferredBTC(this) ? "MCN" : BRSharedPrefs.getIso(this), new BigDecimal(BRWalletManager.getBCashBalance(BRKeyStore.getMasterPublicKey(app))));
