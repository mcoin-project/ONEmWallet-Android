...
import com.onem.onemwallet.presenter.fragments.FragmentPhraseWord;
...
public class PaperKeyActivity extends BRActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (wordArray.length == 12 && cleanPhrase.charAt(cleanPhrase.length() - 1) == '\0') {
            ...
            FirebaseCrash.report(new IllegalArgumentException("Paper Key error, please contact support at onemwallet.com"));
