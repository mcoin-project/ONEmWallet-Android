...
public class FingerprintActivity extends BRActivity {
    ...
    private String getLimitText() {
        ...
        BigDecimal amount = BRExchange.getAmountFromSatoshis(this, "MCN", satoshis);
        ...
        return String.format(getString(R.string.TouchIdSettings_spendingLimit), BRCurrency.getFormattedCurrencyString(this, "MCN", amount), BRCurrency.getFormattedCurrencyString(this, iso, curAmount));
    }
