...
import com.onem.onemwallet.tools.adapter.CurrencyListAdapter;
...
//    private float rate;
    ...
    private void updateExchangeRate() {
        ...
        if (entity != null) {
            ...
            exchangeText.setText(BRCurrency.getFormattedCurrencyString(this, "MCN", new BigDecimal(lites ? 1000 : 1)) + " = " + finalExchangeRate);
        }
        adapter.notifyDataSetChanged();
    }
