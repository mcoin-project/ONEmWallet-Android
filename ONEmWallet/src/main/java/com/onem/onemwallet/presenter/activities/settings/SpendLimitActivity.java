...
import static com.onem.onemwallet.tools.util.BRConstants.ONE_BITCOIN;
...
public class SpendLimitActivity extends BRActivity {
    ...
    private void updateText(int progress) {
        ...
        String string = String.format("%s (%s)", BRCurrency.getFormattedCurrencyString(this, "MCN", amount), BRCurrency.getFormattedCurrencyString(this, iso, curAmount));
